...
CITATIONS = [
    ...
    ("MEV — adjuvan (β-defensin, TLR agonisti)", "Biragyn et al. 2002",
     "Biragyn A, Ruffini PA, Leifer CA, Klyushnenkova E, Shakhov A, Chertov O, et al. Toll-like receptor 4-dependent activation of dendritic cells by β-defensin 2. Science. 2002;298(5595):1025-1029. (N-ucu β-defensin adjuvanı).",
     "10.1126/science.1075565"),
    ("MEV — adjuvan (50S ribozomal L7/L12)", "Rahmani et al. 2019",
     "Rahmani A, Baee M, Rostamtabar M, et al. Development of a conserved chimeric vaccine based on helper T-cell and CTL epitopes for induction of strong immune response against Schistosoma mansoni using immunoinformatics approaches. Int J Biol Macromol. 2019;141:125-136. (50S ribozomal protein L7/L12 N-ucu adjuvanı; TLR4).",
     "10.1016/j.ijbiomac.2019.08.259"),
    ("MEV — adjuvan (PADRE, universal Th epitopu)", "Alexander et al. 1994",
     "Alexander J, Sidney J, Southwood S, Ruppert J, Oseroff C, Maewal A, et al. Development of high potency universal DR-restricted helper epitopes by modification of high affinity DR-blocking peptides. Immunity. 1994;1(9):751-761. (PADRE: pan-HLA-DR bağlayan universal CD4+ yardımcı-T epitopu).",
     "10.1016/s1074-7613(94)80017-0"),
    ("MEV — adjuvan (RS09, sentetik TLR4 agonisti)", "Shanmugam et al. 2012",
     "Shanmugam A, Rajoria S, George AL, Mittelman A, Suriano R, Tiwari RK. Synthetic Toll like receptor-4 (TLR-4) agonist peptides as a novel class of adjuvants. PLoS One. 2012;7(2):e30839. (RS09 = APPHALS; LPS mimiği güvenli TLR4 agonisti).",
     "10.1371/journal.pone.0030839"),
    ("MEV — adjuvan (HBHA, M. tuberculosis)", "Pethe et al. 2001",
     "Pethe K, Alonso S, Biet F, Delogu G, Brennan MJ, Locht C, Menozzi FD. The heparin-binding haemagglutinin of M. tuberculosis is required for extrapulmonary dissemination. Nature. 2001;412(6843):190-194. (HBHA; T-hücre aktivasyonu, UniProt P9WIP9).",
     "10.1038/35084083"),
